...
HD_PWD='C:/Users/helen/Documents/FPGA/VHDL/Hello_Basys/Hello_Basys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_basys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello_basys.tcl -notrace
