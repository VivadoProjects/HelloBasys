...
HD_PWD='C:/Users/helen/Documents/FPGA/VHDL/Hello_Basys/Hello_Basys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_basys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_basys.tcl
